//! Per-instruction operand-legality checks (register range, immediate
//! range, addressing-mode compatibility with the opcode) shared by the
//! decoder and the static binary validator.
//!
