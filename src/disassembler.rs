...
pub fn render_instruction(mnemonic: Mnemonic, operands: Operands, offset: u64, length: u64) -> String {
    ...
    match operands {
        ...
        Operands::RRR { rd, rs1, rs2 } => format!("{} {}, {}, {}", name, reg(rd), reg(rs1), reg(rs2)),
...
mod tests {
    ...
    fn roundtrip(src: &str) {
        ...
        assert_eq!(bin1, bin2, "round-trip mismatch for:\n{}\n---produced---\n{}", src, text);
    }
